...
const Help = () => {
    return (
        <div className='flex flex-col justify-center w-1/10'>
            <div className="absolute top-4 left-4 text-gray-500 hover:text-gray-400 cursor-pointer">
            ...
            <div className="absolute left-2 text-gray-500 hover:text-gray-400 cursor-pointer">
